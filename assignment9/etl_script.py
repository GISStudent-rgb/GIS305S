...
def extract():
    ...
    with open(r"C:\Users\thoma\Downloads\addresses.csv", "w") as output_file:
        output_file.write(data)

    print("Extraction complete")
    return r"C:\Users\thoma\Downloads\addresses.csv"

def transform():
    print ("Add city, State")

    transformed_file = open(r"C:\Users\thoma\Downloads\addresses.csv", "w")
    transformed_file.write("X, Y, Type\n")
    with open(r"C:\Users\thoma\Downloads\addresses.csv", "r") as partial_file:
...
def load():
    print("Loading data")
    # Creates a point feature class from input table

    # Env settings
    arcpy.env.workspace = r"C:\Users\thoma\Desktop\GIS3005\Lab 1\WestNileOutbreak\WestNileOutbreak.gdb"
    arcpy.env.overwriteOutput = True

    # Set local variables
    in_table = r"C:\Users\thoma\Downloads\new_addresses.csv"
